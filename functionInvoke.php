...
function showLoggedIn(){
  ...
  function showUltimate($title,$user,$desig,$nic,$amt){
    ...
    echo "    <h4 class='card-title'>Hi &nbsp" .$title. "&nbsp".$user. "</h4>";
    echo "    <p class='card-text'>Thank You for the Contribution, You are welcome to the Premium Services afford by D.Claude</p>";
    echo "    <p class='text-success'>Thank you for the amazing &nbsp" .$amt. "&nbsp Dollars, given under a designation of &nbsp" .$desig. " </p>";
    echo "    <p class='text-info'>Your NIC: &nbsp " .$nic. "&nbsp is recorded in our database</p>";
    echo "  </div>";
    echo "</div>";
  }
