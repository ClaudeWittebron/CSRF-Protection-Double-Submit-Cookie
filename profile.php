...
<head>
    ...
    <script>
      ...
      function appendToBody(cookieName){
        ...
        document.getElementById('csrf_Token').value=cookieVal;
      }
    </script>
</head>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <?php
        if(isset($_COOKIE['cookie_name'])){
            ...
            echo"<script> console.log(document.cookie);
        ...
        if(isset($_COOKIE['cookie_name'])){
            ...
            <div class='card-body'>
              ...
              <div class='form-group'>
                  <select required name='title' class='custom-select' style='max-width: 5rem;'>
                  ...
                  <input required name='name' class='form-control form-control-sm' placeholder='Name' id='inputSmall' type='text'>
                  <label class='col-form-label col-form-label-sm' for='inputSmall'>Designation</label>
                  <input required name='designation' class='form-control form-control-sm' placeholder='Designation' id='inputSmall' type='text'>
                  <label class='col-form-label col-form-label-sm' for='inputSmall'>NIC</label>
                  <input required name='nic' class='form-control form-control-sm' placeholder='Natinal Identity Card Number' id='inputSmall' type='text'>
              </div>
              ...
              <div class='form-group'>
                  <div class='input-group mb-3'>
                      ...
                      <input required name='amount' class='form-control' aria-label='Amount (to the nearest dollar)' type='text'>
